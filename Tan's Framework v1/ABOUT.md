...
- **AI-Ready Instructions** — `CLAUDE.md` tells AI assistants exactly how to behave in your project — what rules to follow, what files to update, and what questions to ask.
...
| File | What It Does |
|------|-------------|
| `AI-INSTRUCTIONS.md` | Instructions for AI assistants — setup questions and workflow rules |
